...
def nvls_tree_all_reduce(
    ...
    """
    from simulon.collective.tree import _infer_gpus_per_node, _get_tree_topology
    ...
    for ch in range(num_channels):
        ...
        for n, (node_ranks, switch_id) in enumerate(zip(node_groups, switch_ids)):
        ...
        for node_idx in order:
            ...
            parent_fids += [inter_reduce_flow_ids[c] for c in children_nodes if c in inter_reduce_flow_ids]
