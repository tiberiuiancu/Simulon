...
def decompose_collective(
    ...
    elif algorithm not in ("ring", "tree", "collnet_direct", "collnet_chain"):
        raise ValueError(f"Unknown algorithm: {algorithm!r}. Choose from: ring, tree, collnet_direct, collnet_chain")
